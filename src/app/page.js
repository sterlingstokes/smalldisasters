    ...
    <>
      ...
      <div className="border border-dashed border-t-0 border-black px-8">
        <p className="py-4">
          ...
          pitchfork twee subway tile tumblr pickled chicharrones tote bag. Tofu
          slow-carb cupping, DIY shabby chic taxidermy bodega boys master
          ...
          farm-to-table cronut lo-fi knausgaard. Pinterest listicle swag, neutra
          cloud bread praxis jianbing man braid XOXO.
        </p>
        <p className="py-4">
          ...
          Mumblecore 3 wolf moon affogato snackwave, +1 keffiyeh marfa polaroid
          freegan raw denim. Same crucifix meh farm-to-table portland DSA copper
          mug hella. Gatekeep 3 wolf moon keytar mustache iceland shaman food
          truck heirloom truffaut palo santo put a bird on it yes plz swag
          skateboard neutra. Disrupt aesthetic yuccie echo park jianbing marxism
          banjo art party taxidermy direct trade cronut shoreditch mukbang.
        </p>
